        ...
        .each(function() {
          ...
          if (self.is_horizontal_tabs(section) || self.is_auto(section)) {
            ...
            titles.each(function() {
              ...
              if (title.is(":visible")) {
                title.css(Foundation.rtl ? 'right' : 'left', titles_sum_width);
                var title_h_border_width = parseInt(title.css("border-" + (Foundation.rtl ? 'right' : 'left') + "-width"), 10);
            ...
            content.css(Foundation.rtl ? 'right' : 'left', titles_max_width);
